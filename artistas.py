...
ARTISTAS = {
    ...
    "Davikane": {
        ...
        "bio": (
            ...
            "estudiar Medicina se dedicó de lleno a la música. Su estilo fusiona regional mexicano "
            "y tex-mex (banda, rancheras, corridos, cumbia y mariachi), con influencias de Grupo "
        ...
        "ganchos": [
            ...
            "Estilo regional mexicano/tex-mex que encaja directo con la programación de venues de música regional en Texas.",
            "Catálogo de sencillos propios (corridos, banda, tex-mex) listo para shows en vivo de fin de semana.",
